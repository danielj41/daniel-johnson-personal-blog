...
(I don't think this is actually the same as autofocus in html? research more)
...
- Does not work if any other element has an `autofocus` attribute when this component is mounted. (not true, delete this)
